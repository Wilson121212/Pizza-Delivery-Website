...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['addPotato'])) {
        // Determine itemID based on selected size
        $size = $_POST['Potatosize'];
        $thickness = $_POST['Potatothickness'];
        $sauce = $_POST['Potatosauce'];
        $quantity = isset($_POST['PotatoQty']) ? (int)$_POST['PotatoQty'] : 0;
        ...
        if ($quantity > 0) {
            ...
            if ($stmt->execute()) {
                $successMessage = "$quantity x Potato Pizza (Size: $size, Thickness: $thickness, Sauce: $sauce) has been successfully added.";
            } else {
...
<body>
    ...
    <main>
        <div class="pizza-detail">
            <img src="Potato Pizza.jpg" alt="Potato Pizza">
            <h2>Potato Pizza</h2>
            <p>Unique and utterly satisfying, our Potato Pizza is a carb lover's paradise. Thinly sliced, rosemary-infused potatoes, caramelized onions, and gorgonzola cheese.</p>
            <p>4.3 ⭐ (170)</p>
            <p>$14.90</p>
        </div>        
    ...
    <form id="customizeForm" method="post">
        ...
        <select id="sauce" name="Potatosauce">
        ...
        <select id="thickness" name="Potatothickness">
        ...
        <select id="size" name="Potatosize">
            <option value="small">Small - 10"</option>
            <option value="medium">Medium - 12"</option>
            <option value="large">Large - 14"</option>
        </select>

        <label for="PotatoQty">Quantity:</label>
        <input type="number" min="0" id="PotatoQty" 
        name="PotatoQty" value="0" >
        
        <button type="submit" class="add-to-cart-button" name="addPotato">Add to Cart</button>
    </form>
    </main>
    </section>
