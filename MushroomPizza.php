...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['addShroomzza'])) {
        // Determine itemID based on selected size
        $size = $_POST['Shroomzzasize'];
        $thickness = $_POST['Shroomzzathickness'];
        $sauce = $_POST['Shroomzzasauce'];
        $quantity = isset($_POST['ShroomzzaQty']) ? (int)$_POST['ShroomzzaQty'] : 0;
        ...
        if ($quantity > 0) {
            ...
            if ($stmt->execute()) {
                $successMessage = "$quantity x Shroomzza Pizza (Size: $size, Thickness: $thickness, Sauce: $sauce) has been successfully added.";
            } else {
...
<body>
    ...
    <section class="menu">
        ...
        <div class="pizza-detail">
            <img src="Mushroom Pizza.png" alt="Shroomzza">
            <h2>Shroomzza</h2>
            <p>For the fungi aficionado, the Shroomzza is a rich tapestry of earthy flavors. It features an assortment of wild mushrooms, truffle oil, and thyme on a bed of white sauce and mozzarella cheese.</p>
            <p>4.6 ⭐ (260)</p>
            <p>$16.90</p>
        </div>        
    ...
    <form method="post" id="customizeForm">
        ...
        <select id="sauce" name="Shroomzzasauce">
        ...
        <select id="thickness" name="Shroomzzathickness">
        ...
        <select id="size" name="Shroomzzasize">
            <option value="small">Small - 10"</option>
            <option value="medium">Medium - 12"</option>
            <option value="large">Large - 14"</option>
        </select>

        <label for="ShroomzzaQty">Quantity: Minimum (2)</label>
        <input type="number" min="2" id="ShroomzzaQty" 
        name="ShroomzzaQty" value="0" >
        
        <button type="submit" class="add-to-cart-button" name="addShroomzza">Add to Cart</button>
