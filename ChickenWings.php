...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['addChickenWings'])) {
        $quantity = isset($_POST['ChickenWingsQty']) ? (int)$_POST['ChickenWingsQty'] : 0;
        $itemID = 24;
        ...
        if ($quantity > 0) {
            ...
            if ($stmt->execute()) {
                $successMessage = "$quantity x Chicken Wings have been successfully added.";
            } else {
...
<body>
    ...
    <section class="menu">
        ...
        <div class="pizza-detail">
                ...
                <h2>Chicken Wings</h2>
                <p>Juicy chicken wings, lightly seasoned and fried to perfection.</p>
                <p>4.9 ⭐ (174)</p>
                <p>$7.50</p>
        </div>

            <form method="post" id="customizeForm1" class="grey-box">
                <label for="ChickenWingsQty">Quantity:</label>
                <input type="number" min="0" id="ChickenWingsQty" name="ChickenWingsQty" value="0">
                <button type="submit" class="add-to-cart-button" name="addChickenWings">Add to Cart</button>
            </form>
        </main>
    </section>
