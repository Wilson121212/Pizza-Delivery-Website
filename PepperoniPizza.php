...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['addPepperoni'])) {
        ...
        $size = $_POST['Pepperonisize'];
        $thickness = $_POST['Pepperonithickness'];
        $sauce = $_POST['Pepperonisauce'];
        $quantity = isset($_POST['PepperoniQty']) ? (int)$_POST['PepperoniQty'] : 0;
        ...
        if ($quantity > 0) {
            ...
            if ($stmt->execute()) {
                $successMessage = "$quantity x Pepperoni Pizza (Size: $size, Thickness: $thickness, Sauce: $sauce) has been successfully added.";
            } else {
...
<body>
    ...
    <main>
        <div class="pizza-detail">
            ...
            <p>Dive into the bold flavors of our Pepperoni Pizza, a robust favorite loaded with crispy, curling slices of pepperoni. Perfectly baked for that irresistible crunch.</p>
            <p>4.9 ⭐ (204)</p>
            <p>$15.90</p>
        </div>      
    ...
    <form id="customizeForm" method="post">
        ...
        <select id="sauce" name="Pepperonisauce">
        ...
        <select id="thickness" name="Pepperonithickness">
        ...
        <select id="size" name="Pepperonisize">
            <option value="small">Small - 10"</option>
            <option value="medium">Medium - 12"</option>
            <option value="large">Large - 14"</option>
        </select>

        <label for="PepperoniQty">Quantity:</label>
        <input type="number" min="0" id="PepperoniQty" 
        name="PepperoniQty" value="0" >

        <button type="submit" class="add-to-cart-button" name="addPepperoni">Add to Cart</button>
    </form>
    </main>
    </section>
