...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['addGarlicBread'])) {
        $quantity = isset($_POST['GarlicBreadQty']) ? (int)$_POST['GarlicBreadQty'] : 0;
        $itemID = 25;
        ...
        if ($quantity > 0) {
            ...
            if ($stmt->execute()) {
                $successMessage = "$quantity x Garlic Bread has been successfully added.";
            } else {
...
<head>
    ...
    <title>Garlic Bread - PengYu's Pizzas</title>
...
<body>
    ...
    <div class="pizza-container">
        <div class="pizza-detail">
            ...
            <h2>Garlic Bread</h2>
            <p>Crunchy on the outside, soft on the inside. Our perfectly baked garlic bread brushed with garlic butter and herbs.</p>
            <p>4.7 ⭐ (154)</p>
            <p>$4.50</p>
        </div>

        <form method="post" id="customizeForm1" class="grey-box">
            <label for="GarlicBreadQty">Quantity:  </label>
            <input type="number" min="0" id="GarlicBreadQty" name="GarlicBreadQty" value="0" >
            <button type="submit" class="add-to-cart-button" name="addGarlicBread">Add to Cart</button>
        </form>
    </div>
    </main>
    </section>
